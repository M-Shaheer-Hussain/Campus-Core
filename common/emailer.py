...
ADMIN_EMAIL = "muhammadhussainfarhan1@lhr.nu.edu.pk"  # replace with actual admin email
...
def send_code(code):
    ...
    sender_email = "muhammadhussainfarhan1@gmail.com"
    sender_password = "gzas wcgv pvug oxxo"
